...
const st = {
  ...
  scrollerProgressFill: {
    height: "100%",
    width: "0%",
    background: "linear-gradient(90deg, rgba(212,175,55,0.7), rgba(251,191,36,1))",
    borderRadius: 999,
  ...
  cardTileSelected: {
    borderColor: "#d4af37",
    boxShadow: "0 0 0 1px rgba(212,175,55,0.5), 0 0 24px rgba(212,175,55,0.25)",
  ...
  checkOverlay: {
    ...
    top: 8, right: 8,
    width: 28, height: 28,
    background: "linear-gradient(135deg, #e6c463, #d4af37)",
    color: "#0f172a",
    borderRadius: "50%",
    display: "flex", alignItems: "center", justifyContent: "center",
  ...
  financeValue:       { color: "#e6c463", fontWeight: 800 },
  ...
  summarySideTotal: {
    fontSize: "0.78rem", color: "#e6c463",
    marginTop: "0.4rem", fontWeight: 700,
    fontVariantNumeric: "tabular-nums",
    letterSpacing: "0.02em",
  },
  summaryArrow: {
    fontSize: "1.5rem", color: "#d4af37", fontWeight: 800,
  },
  diffRow: {
    display: "flex", alignItems: "center", justifyContent: "center",
    gap: "0.85rem",
  ...
  executeBtn: {
    ...
    letterSpacing: "0.04em",
    cursor: "pointer",
    boxShadow: "0 8px 24px rgba(212,175,55,0.35), 0 0 0 1px rgba(212,175,55,0.45)",
  ...
  modalConfirmBtn: {
    ...
    letterSpacing: "0.03em",
    cursor: "pointer",
    boxShadow: "0 6px 18px rgba(212,175,55,0.3), 0 0 0 1px rgba(212,175,55,0.45)",
  },
  ...
  animThumb: {
    ...
    borderRadius: 10,
    overflow: "hidden",
    boxShadow: "0 12px 32px rgba(0,0,0,0.55), 0 0 0 1px rgba(212,175,55,0.18)",
    flexShrink: 0,
  },
  animThumbImg: {
    width: "100%",
  ...
  historyCashOut: { color: "#e6c463", fontWeight: 700 },
  historyPnl: {
    fontSize: "0.95rem", fontWeight: 800,
    fontVariantNumeric: "tabular-nums",
    letterSpacing: "-0.01em",
  ...
  loadingProgressFill: {
    height: "100%",
    background: "linear-gradient(90deg, rgba(212,175,55,0.85), #e6c463, #fde68a)",
    borderRadius: 999,
